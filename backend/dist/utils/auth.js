...
exports.generateToken = function (userId) {
    var secret = process.env.JWT_SECRET || 'your-secret-key-change-this';
...
exports.comparePassword = function (password, hashedPassword) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
exports.generateMembershipId = function (userId) {
    var date = new Date();
