...
const sendMembershipReceipt = async (userData) => {
...
exports.sendMembershipReceipt = sendMembershipReceipt;
const sendBirthdayWish = async (userData) => {
...
const sendCertificateEmail = async (userData) => {
...
const sendEventRegistrationEmail = async (userData) => {
...
const sendMessageToMember = async (userData) => {
...
const sendEnquiryResponseEmail = async (userData) => {
...
exports.sendEnquiryResponseEmail = sendEnquiryResponseEmail;
const sendCampaignUpdateEmail = async (userData) => {
...
exports.sendCampaignUpdateEmail = sendCampaignUpdateEmail;
