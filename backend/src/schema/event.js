...
const eventSchema = new Schema({
  ...
  registrations: [{ type: mongoose.Schema.Types.ObjectId, ref: 'User' }], registrationCount: { type: Number, default: 0 }, status: { type: String, enum: ['upcoming', 'scheduled', 'ongoing', 'completed', 'cancelled'], default: 'upcoming' }
