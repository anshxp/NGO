...
export const volunteerResolvers = {
    Query: {
        getAllVolunteers: async (args: any, context: any) => {
            console.log('\n🔵 ===== getAllVolunteers CALLED =====');
            if (!context.user || context.user.role !== 'admin') {
                throw new Error('Unauthorized: Only admins can view volunteers');
            }
            try {
                const volunteers = await VolunteerModel.find().sort({ created_at: -1 });
        ...
        getVolunteerById: async (args: any, context: any) => {
            console.log('\n🔵 ===== getVolunteerById CALLED =====');
            console.log('📦 Volunteer ID:', args.id);
            try {
                const volunteer = await VolunteerModel.findById(args.id);
                if (!volunteer) {
        ...
        getActiveVolunteers: async (args: any, context: any) => {
        ...
        getVolunteersBySkill: async (args: any, context: any) => {
        ...
        getVolunteersByAvailability: async (args: any, context: any) => {
    ...
    Mutation: {
        registerVolunteer: async (args: any, context: any) => {
        ...
        updateVolunteerStatus: async (args: any, context: any) => {
        ...
        updateVolunteerHours: async (args: any, context: any) => {
            ...
            try {
                const volunteer = await VolunteerModel.findById(args.volunteerId);
        ...
        assignTaskToVolunteer: async (args: any, context: any) => {
        ...
        verifyVolunteerBackground: async (args: any, context: any) => {
            ...
            try {
                const volunteer = await VolunteerModel.findByIdAndUpdate(
                    args.volunteerId,
                    { backgroundVerified: args.verified },
                    { new: true }
                );
        ...
        deleteVolunteer: async (args: any, context: any) => {
            ...
            try {
                const volunteer = await VolunteerModel.findByIdAndDelete(args.volunteerId);
