...
export const sendDonationReceipt = async (donationData: any) => {
...
export const sendMembershipReceipt = async (userData: any) => {
...
export const sendBirthdayWish = async (userData: any) => {
...
export const sendCertificateEmail = async (userData: any) => {
...
export const sendEventRegistrationEmail = async (userData: any) => {
...
export const sendMessageToMember = async (userData: any) => {
...
export const sendEnquiryResponseEmail = async (userData: any) => {
...
export const sendCampaignUpdateEmail = async (userData: any) => {
